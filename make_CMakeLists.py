...
files = unit_test_source_files("unit/clusterography", additional)
cmake_file_strings = as_cmake_file_strings(files)
cmakelists = cmakelists.replace("@casm_unit_clusterography_source_files@", cmake_file_strings)

files = unit_test_source_files("unit/configuration", additional)
cmake_file_strings = as_cmake_file_strings(files)
cmakelists = cmakelists.replace("@casm_unit_configuration_source_files@", cmake_file_strings)

files = unit_test_source_files("unit/enumeration", additional)
cmake_file_strings = as_cmake_file_strings(files)
cmakelists = cmakelists.replace("@casm_unit_enumeration_source_files@", cmake_file_strings)

files = unit_test_source_files("unit/occ_events", additional)
cmake_file_strings = as_cmake_file_strings(files)
cmakelists = cmakelists.replace("@casm_unit_occ_events_source_files@", cmake_file_strings)
