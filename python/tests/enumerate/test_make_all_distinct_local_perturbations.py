...
# def test_enum_perturbations_1():
#     xtal_prim = xtal_prims.FCC(a=1.0, occ_dof=["A", "B", "Va"])
#     prim = config.Prim(xtal_prim)
#     system = occ_events.OccSystem(xtal_prim=xtal_prim)
#
#     cluster_specs = enum.make_first_n_orbits_cluster_specs(
#         prim=prim,
#         n_orbits=[0, 0, 2, 2],
#     )
#
#     for orbit in cluster_specs.make_orbits():
#         print(xtal.pretty_json(orbit[0].to_dict(xtal_prim=xtal_prim)))
#
#     events = occ_events.make_canonical_prim_periodic_occevents(
#         system=system,
...
#         print()
#
#         lcl = enum.LocalConfigurationList(
#             prim_sym_info=enum.OccEventPrimSymInfo(
#                 prim=prim,
#                 prototype_event=event,
#             ),
#         )
#
#         config_enum = enum.ConfigEnumLocalOccupations(
#             prim_sym_info=lcl,
